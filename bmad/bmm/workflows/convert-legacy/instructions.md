...
<parameter name="You MUST have already loaded and processed: {project-root}/bmad/bmm/workflows/convert-legacy/workflow.yaml</critical>
...
<invoke-workflow>
  workflow: {project-root}/bmad/bmm/workflows/create-agent/workflow.yaml
  inputs:
...
<invoke-workflow>
  workflow: {project-root}/bmad/bmm/workflows/create-workflow/workflow.yaml
  inputs:
...
<invoke-workflow>
  workflow: {project-root}/bmad/bmm/workflows/create-module/workflow.yaml
  inputs:
