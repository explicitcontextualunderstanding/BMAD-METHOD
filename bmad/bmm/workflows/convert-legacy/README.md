...
- Review the workflow creation guide at `/bmad/bmm/workflows/create-workflow/workflow-creation-guide.md`
- Check conversion mappings at `/bmad/bmm/data/v4-to-v6-mappings.yaml`
