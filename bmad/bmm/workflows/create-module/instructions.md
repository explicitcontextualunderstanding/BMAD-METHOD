...
<critical>You MUST have already loaded and processed: {project-root}/bmad/bmm/workflows/create-module/workflow.yaml</critical>
...
<check if="create">
  <action>Invoke module-brief workflow: {project-root}/bmad/bmm/workflows/module-brief/workflow.yaml</action>
